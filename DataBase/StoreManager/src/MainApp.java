...
public class MainApp {
    public static void main(String[] args) {
        ...
        //StoreManager.getInstance().getMenuView().setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        //StoreManager.getInstance().getProductView().setVisible(true); // Show the ProductView!
        //StoreManager.getInstance().getMenuView().setVisible(true);
        mainMenu menuView = new mainMenu();
        mainMenuController mainController = new mainMenuController(menuView);
